...
<body>
    ...
    <!-- Hay que revisar esto del main para añadir la busqueda -->
    <main class="container mt-4">
        <section id="tareas" class="row">
            <div id="columna-pendiente" class="col-12 mb-4 columna-tareas">
                <div class="container my-4 estado-actual" data-estado="Pendiente">
                    <input type="text" id="buscar-tarea-pendiente" class="form-control" placeholder="Buscar tarea...">
                </div>
                <div class="card">
            ...
            <div id="columna-ejecución" class="col-12 mb-4 columna-tareas d-none">
                <div class="container my-4 estado-actual" data-estado="Ejecucion">
                    <input type="text" id="buscar-tarea-ejecuccion" class="form-control" placeholder="Buscar tarea...">
                </div>
                <div class="card">
            ...
            <div id="columna-finalizada" class="col-12 mb-4 columna-tareas d-none">
                <div class="container my-4 estado actual" data-estado="Finalizada">
                    <input type="text" id="buscar-tarea-finalizada" class="form-control" placeholder="Buscar tarea...">
                </div>
                <div class="card">
